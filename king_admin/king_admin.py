...
class CourseAdmin(BaseAdmin):
    ...
    list_editable = ['name', 'price', 'period', 'outline']
...
class ClassListAdmin(BaseAdmin):
    list_display = ['branch', 'course', 'class_type', 'contract', 'start_date', 'end_date']
...
class ContractTemplate(BaseAdmin):
...
# def teacher_register(model_class, admin_class=None):
#     if model_class._meta.app_label not in teacher_admins:
#         teacher_admins[model_class._meta.app_label] = {}  # enabled_admins['crm'] = {}
#     # admin_obj = admin_class()
#     admin_class.model = model_class  # 绑定model 对象和admin 类
#     teacher_admins[model_class._meta.app_label][model_class._meta.model_name] = admin_class
    # enabled_admins['crm']['customerfollowup'] = CustomerFollowUpAdmin
